<template>
	<div>
		<div class="contain">
			...
			<div class="row text">
				<div>
					<textarea v-model="opinion" maxlength="200" placeholder="点击这里输入您的意见" class="input"></textarea>
					<label class="word_count">{{word_count}}/200</label>
				</div>
			</div>
			<div class="row">
				<div>
      ...
      <div class="row">
        ...
        <input v-model="wechat" maclength="20" placeholder="详细交流，点击这里" class="wechat-input"></input>
      </div>
		</div>
